...
- **Lazy Tools:** To call `fetch_user_profile`, you MUST use the generic `call_mcp_tool` native tool with EXACTLY these arguments: `{"ServerName": "warlock", "ToolName": "fetch_user_profile", "Arguments": {"profile_name": "<operator_id>"}}`
